...
到现在为止，我们的小球已经可以开始愉快地动起来啦 :kissing_smiling_eyes: ，然后我们加上一点小球的碰撞检测，`Ball.prototype.collisionDetect` 位置加在 `Ball.prototype.update` 之后。
...
<canvas></canvas>
<script src="https://github.com/b1uuue/zNote/blob/master/myScript/BouncingBall.js"></script>
